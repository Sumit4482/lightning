...
// import { DailySectionComponent } from './features/daily/daily-section.component';
  ...
  ngOnInit(): void {
    ...
    this.router.events
      ...
      .subscribe((e) => {
        ...
        this.syncRouteMode(url);
      });
  }

  private syncRouteMode(url: string): void {
    this.showPortfolio = !url.startsWith('/publish');
    const scrollable = !this.showPortfolio;
    document.documentElement.classList.toggle('route-scroll', scrollable);
    document.body.classList.toggle('route-scroll', scrollable);
  }
